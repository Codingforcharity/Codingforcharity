...
// var cache = new Cache();
var error = new gutil.PluginError("test", "something broke", {
  showStack: true
});
...
gulp.task(
  "serve",
  ["optimize-image", "build-js2", "sass2", "html2", "videos", "fonts", "files"],
  function() {
    var stream = nodemon({
    ...
    gulp.watch(["bundle/img/**/*"]).on("change", browserSync.reload);
    gulp.watch(["public/**/*.js"], ["build-js2"]);
